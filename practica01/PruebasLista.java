...
public class PruebasLista{
    ...
    public static double pruebaConstructorIterable(){
		...
		try{
			...
			Lista<Integer> lista = new Lista<Integer>(c);
    ...
    public static double pruebaGetElemento(){
			...
			System.out.println("**************Prueba getElemento***************"); //getElemento
		try{
			double calificacion = 0;
			Lista<String> lista = new Lista<>();
			lista.agregarAlFinal("h");
			...
			System.out.println("**************Prueba getElemento***************");
    ...
    public static double pruebaEquals(){
			...
			System.out.println("****************Prueba equals*****************"); //debería decir Prueba equals
		try{
			double calificacion = 0;
